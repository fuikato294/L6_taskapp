...
class InputViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // dismissKeyboard()メソッドがendEditing(true)を呼び出してキーボードを閉じる
        // 背景をタップしたらdismissKeyboardメソッドを呼ぶように設定する
        // targetを self(inputViewController自身)の dismissKeyboard()メソッドに指定
        // ここでは、viewプロパティが背景に該当するため、addGestureRecognizer(_:)メソッドを使ってviewにUITapGestureRecognizerを登録
